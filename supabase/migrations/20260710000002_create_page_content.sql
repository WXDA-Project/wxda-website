-- Editable prose blocks for static pages (home, about, history), stored as markdown
...
create policy "admin all" on page_content
  for all to authenticated
  using (true)
  with check (true);

-- Seed with existing static page prose
insert into page_content (key, label, content) values
(
  'home.welcome',
  'Home — Welcome',
  'Welcome to the Waterloo Cross-Dressing Archive. This website gives you access to a growing database of eighteenth- and nineteenth-century periodical records of the real-world adoption of gender-variant garb. By “cross-dressing,” we refer to material practices involving the adoption of gender-variant clothing, including for the purposes of expressing one’s gender.

If you were living around 1800 and made the decision to adopt differently gendered garb, how would someone in the future know about what you did, why you did it, or how you felt about doing it? How would your actions have been understood at the time, and how may we understand them now? This archive is meant to collect records that will help us explore, and seek answers to, these questions.

Consider, for example, a report from February 1786 about the death of a “woman” who “constantly appeared in the disguise of man’s apparel” for over 30 years while working as a shepherd and paver, who proposed marriage “to several young women,” and who, if only they had found “a professional man in whom she could have safely reposed confidence,” would have gone to their death known only as a man. Was this cross-dressing instrumental (to work as a man), sexual (to pursue other women), transgender (to be a man)? [Take a look at the WXDA record](/record/563) to explore this matter for yourself.

Visit our [news page](/about/news) for updates and additional information.
